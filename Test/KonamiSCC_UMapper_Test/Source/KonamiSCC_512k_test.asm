...
Seg_P6000_SW:	equ	07000h	; Segment switch for page 6000h-7FFFh (Konami SCC Mapper)
Seg_P8000_SW:	equ	09000h	; Segment switch for page 8000h-9FFFh (Konami SCC Mapper)	
Seg_PA000_SW:	equ	0B000h	; Segment switch for page A000h-BFFFh (Konami SCC Mapper)
PosText1:       equ	06000h	; 	
PosText2:       equ	08000h	; 	
PosText3:       equ	0A000h	; 		
...
; Typical routine to select the ROM on page 8000h-BFFFh from page 4000h-7BFFFh
	...
	ld	hl,asc_test_string_page0
	call	Print		; Call the routine Print below

	ld	hl,asc_test_string_page1
	call	Print		; Call the routine Print below
	ld	hl,PosText1	; Text pointer into HL
	call	Print		; Call the routine Print below
	ld	hl,txt_new_line	; Text pointer into HL
	call	Print		; Call the routine Print below

	ld	hl,asc_test_string_page2
	call	Print		; Call the routine Print below
...
asc_test_string_page0:
	db "Page 0 segment: 00",LF,CR, 0;  
asc_test_string_page1:
	db "Page 1 segment: ", 0	;  
asc_test_string_page2:
	db "Page 2 segment: ", 0	;  
asc_test_string_page3:
	db "Page 3 segment: ", 0	;  	
text_page_0x6000:
	db "Page 0x6000-0x7FFF seg:",LF,CR,0	; 
text_page_0x8000:
	db "Page 0x8000-0x9FFF seg:",LF,CR,0	; 
text_page_0xA000:
	db "Page 0xA000-0xBFFF seg:",LF,CR,0	; 
...
txt_new_line:
	...
	db "01 ",0	; Zero indicates the end of text.
